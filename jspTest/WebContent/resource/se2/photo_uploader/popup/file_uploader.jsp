...
//String path = "D:/workspace/jejuya_v1_1/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/jspTest/resource/image/"; // 이미지가 저장될 주소
//String path = (request.getSession().getServletContext().getRealPath("/") + File.separator + "projectJeju");
String path = (request.getSession().getServletContext().getRealPath("/") + "projectJeju");
String filename = "";
